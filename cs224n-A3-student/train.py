...
def train(
    ...
    # 创建形状为 [batch_size, seq_len] 的致密批次
    ...
    for i in tqdm(range(0, num_chunks, batch_size), desc="训练中", total=tqdm_max_steps):
